...
import { USER_SIGNIN, USER_SIGNOUT, USER_SIGNUP } from './service';
...
const userSlice = createSlice({
    ...
    extraReducers: {
        ...
        [signIn.fulfilled]: (state, { payload }) => {
            ...
            return { ...state, status: true, message: payload.data.message, token: payload.data.token, isAuthenticated: true }
        },
